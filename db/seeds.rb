...
# user = User.create(:id)
user3 = User.create!(id:7, email:"email3@email.com", role: "member", password:"123456")
user4 = User.create!(id:8, email:"email4@email.com", role: "member", password:"123456")
user5 = User.create!(id:9, email:"email5@email.com", role: "member", password:"123456")
user6 = User.create!(id:10, email:"email6@email.com", role: "member", password:"123456")
